...
namespace DTXmatixx.ステージ.演奏
{
    class 達成率表示 : Activity
    {
        ...
        public void 描画する( グラフィックデバイス gd, DeviceContext1 dc, float 達成率 )
        {
            ...
            gd.D2DBatchDraw( dc, () => {
                ...
                this._達成率ロゴ画像.描画する( gd, dc, 0f, 0f );
                ...
                this._数字画像.描画する( gd, dc, 0f, 0f, 達成率文字列.Substring( 3 ) );
                ...
                this._数字画像.描画する( gd, dc, 0f, 0f, 達成率文字列.Substring( 0, 3 ) );
