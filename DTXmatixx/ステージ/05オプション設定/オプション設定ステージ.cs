        ...
        protected override void On活性化()
        {
            using( Log.Block( FDKUtilities.現在のメソッド名 ) )
            {
                ...
                this._ルートパネルフォルダ.子パネルリスト.Add(
                    new パネル_文字列リスト(
                        パネル名: "演奏モード",
                        初期選択肢番号: (int) user.演奏モード,
                        選択肢初期値s: new[] { "BASIC", "EXPERT" },
                        値の変更処理: new Action<パネル>( ( panel ) => {
                ...
                //----------------
                #endregion
                #region " 入力発声スレッドのスリープ量 "
                //----------------
                this._ルートパネルフォルダ.子パネルリスト.Add(
                    new パネル_文字列リスト(
                        パネル名: "入力発声スレッドのスリープ量",
                        初期選択肢番号: ( App.システム設定.入力発声スレッドのスリープ量ms - 1 ),   // 1～10 → 0～9
                        選択肢初期値s: new[] { "1 ms", "2 ms", "3 ms", "4 ms", "5 ms", "6 ms", "7 ms", "8 ms", "9 ms", "10 ms" },
                        値の変更処理: new Action<パネル>( ( panel ) => {
                ...
                this._ルートパネルフォルダ.子パネルリスト.Add(
                    new パネル_文字列リスト(
                        パネル名: "Rideの表示位置",
                        初期選択肢番号: ( user.表示レーンの左右.Rideは左 ) ? 0 : 1,
                        選択肢初期値s: new[] { "左", "右" },
                        値の変更処理: new Action<パネル>( ( panel ) => {
                ...
                this._ルートパネルフォルダ.子パネルリスト.Add(
                    new パネル_文字列リスト(
                        パネル名: "Chinaの表示位置",
                        初期選択肢番号: ( user.表示レーンの左右.Chinaは左 ) ? 0 : 1,
                        選択肢初期値s: new[] { "左", "右" },
                        値の変更処理: new Action<パネル>( ( panel ) => {
                            user.表示レーンの左右 = new 表示レーンの左右() {
                ...
                this._ルートパネルフォルダ.子パネルリスト.Add(
                    new パネル_文字列リスト(
                        パネル名: "Splashの表示位置",
                        初期選択肢番号: ( user.表示レーンの左右.Splashは左 ) ? 0 : 1,
                        選択肢初期値s: new[] { "左", "右" },
                        値の変更処理: new Action<パネル>( ( panel ) => {
                            user.表示レーンの左右 = new 表示レーンの左右() {
                                Rideは左 = user.表示レーンの左右.Rideは左,
                ...
                //----------------
                {
                    ...
                    this._ルートパネルフォルダ.子パネルリスト.Add(
                        new パネル_文字列リスト(
                            パネル名: "レーン配置",
                            初期選択肢番号: ( 選択肢s.Contains( user.レーン配置 ) ) ? 選択肢s.IndexOf( user.レーン配置 ) : 0,
                            選択肢初期値s: 選択肢s,
                            値の変更処理: new Action<パネル>( ( panel ) => {
                                user.レーン配置 = 選択肢s[ ( (パネル_文字列リスト) panel ).現在選択されている選択肢の番号 ];
                            } ) ) );
                }
                //----------------
                #endregion
                ...
                //----------------
                {
                    ...
                    this._ルートパネルフォルダ.子パネルリスト.Add( 自動演奏 );
                }
                //----------------
                #endregion
                #region " 入力割り当て "
                ...
                this._ルートパネルフォルダ.子パネルリスト.SelectLast();  // 最後のパネルを選択。
