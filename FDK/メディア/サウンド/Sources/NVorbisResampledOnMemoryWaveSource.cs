...
namespace FDK
{
    ...
    ///		リサンプラーあり版。
    /// </summary>
    public class NVorbisResampledOnMemoryWaveSource : IWaveSource
    {
        ...
        /// <summary>
        ///		コンストラクタ。
        ///		指定されたVorbisファイルを指定されたフォーマットでデコードし、内部にオンメモリで保管する。
        /// </summary>
        public NVorbisResampledOnMemoryWaveSource( Stream stream, WaveFormat deviceFormat )
        {
