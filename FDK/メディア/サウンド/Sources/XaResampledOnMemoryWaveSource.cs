...
namespace FDK.メディア.サウンド.Sources
{
    ...
    ///		リサンプラーあり版。
    /// </summary>
    class XaResampledOnMemoryWaveSource : IWaveSource
    {
        ...
        /// </summary>
        public XaResampledOnMemoryWaveSource( VariablePath ファイルパス, WaveFormat deviceFormat )
        {
            ...
            using( var xaSource = new XAOnMemoryWaveSource( ファイルパス, deviceFormat ) )
